...
bool Turtlebot3MotorDriver::readEncoder(int32_t &front_left_value, int32_t &front_right_value, int32_t &back_left_value, int32_t &back_right_value)
{
...
bool Turtlebot3MotorDriver::writeVelocity(int64_t front_left_value, int64_t front_right_value, int64_t back_left_value, int64_t back_right_value)
{
