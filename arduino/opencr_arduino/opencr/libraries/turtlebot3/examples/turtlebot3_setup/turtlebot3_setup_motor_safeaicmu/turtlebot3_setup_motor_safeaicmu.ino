...
bool setupMotorFrontLeft(void);
bool setupMotorFrontRight(void);
bool setupMotorBackLeft(void);
bool setupMotorBackRight(void);
...
void loop()
{
  ...
  if (CMD_SERIAL.available())
  {
    ...
    if (ch == '3')
    {
      ...
      if (requestConfirm() == true)
      {
        CMD_SERIAL.println("setup.... back left");
    ...
    if (ch == '4')
    {
      ...
      if (requestConfirm() == true)
      {
        CMD_SERIAL.println("setup.... back right");
    ...
    {
      flushCmd();
      CMD_SERIAL.println("test.... back left");
      testMotor(3);
    }
    if (ch == '8')
    {
      flushCmd();
      CMD_SERIAL.println("test.... back right");
      testMotor(4);
    }
...
void drawTitle(void)
{
  ...
  CMD_SERIAL.println("3. setup back left  motor");
  CMD_SERIAL.println("4. setup back right motor");
  CMD_SERIAL.println("5. test front left  motor");
  CMD_SERIAL.println("6. test front right motor");
  CMD_SERIAL.println("7. test back left  motor");
  CMD_SERIAL.println("8. test back right motor");
  CMD_SERIAL.print(">> ");
}
...
bool setupMotorFrontLeft(void)
{
  CMD_SERIAL.println("Setup Motor Front Left...");
...
bool setupMotorFrontRight(void)
{
  CMD_SERIAL.println("Setup Motor Front Right...");
...
bool setupMotorBackLeft(void)
{
  CMD_SERIAL.println("Setup Motor Back Left...");
  ...
  {
    write(portHandler, packetHandler2, tb3_id, 64, 1, 0);
    write(portHandler, packetHandler2, tb3_id, 7, 1, 3);
    tb3_id = 3;
    write(portHandler, packetHandler2, tb3_id, 8, 1, 3);
    portHandler->setBaudRate(1000000);
    write(portHandler, packetHandler2, tb3_id, 10, 1, 2);
    write(portHandler, packetHandler2, tb3_id, 11, 1, 1);
    CMD_SERIAL.println("    ok");
  }
}
...
bool setupMotorBackRight(void)
{
  CMD_SERIAL.println("Setup Motor Back Right...");
  ...
  {
    write(portHandler, packetHandler2, tb3_id, 64, 1, 0);
    write(portHandler, packetHandler2, tb3_id, 7, 1, 4);
    tb3_id = 4;
    write(portHandler, packetHandler2, tb3_id, 8, 1, 3);
    portHandler->setBaudRate(1000000);
    write(portHandler, packetHandler2, tb3_id, 10, 1, 3);
    write(portHandler, packetHandler2, tb3_id, 11, 1, 1);
    CMD_SERIAL.println("    ok");
  }
}
...
void testMotor(uint8_t id)
{
  ...
  if (id == 1)
  {
    CMD_SERIAL.printf("Test Motor Front Left...");
  }
  else if (id == 2)
  {
    CMD_SERIAL.printf("Test Motor Front Right...");
  }
  else if (id == 3)
  {
    CMD_SERIAL.printf("Test Motor Back Left...");
  }
  else // id == 4
  {
    CMD_SERIAL.printf("Test Motor Back Right...");
  }
